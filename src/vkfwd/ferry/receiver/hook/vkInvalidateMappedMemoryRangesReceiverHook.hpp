...
template<>
struct CommandHooks<::vkfwd::generated::CommandId::InvalidateMappedMemoryRanges> {
    ...
    static bool replace_endpoint(const CommandStream & request_stream, const Range & request_range, CommandStream & response_stream,
        ...
        (void) replay_context;
        // The standard generated vkInvalidateMappedMemoryRanges command lacks
        // the response-stream byte payload needed to deliver receiver bytes
        // back to source staging. The public Vulkan entry point must use
        // manual::CommandId::MemoryInvalidate instead.
        VKFWD_LOG_ERROR("vkfwd receiver: standard generated vkInvalidateMappedMemoryRanges command is disabled; use manual::CommandId::MemoryInvalidate");
        return false;
    }
};
