...
struct CommandHooks<::vkfwd::generated::CommandId::UnmapMemory> {
    ...
    static bool replace_endpoint(const CommandStream & request_stream, const Range & request_range, CommandStream & response_stream,
        ...
        (void) replay_context;
        // Standard generated vkUnmapMemory lacks the staged byte payload and
        // receiver-side cache maintenance required by vkfwd. The public Vulkan
        // entry point must use manual::CommandId::MemoryUnmap instead.
        VKFWD_LOG_ERROR("vkfwd receiver: standard generated vkUnmapMemory command is disabled; use manual::CommandId::MemoryUnmap");
        return false;
    }
};
