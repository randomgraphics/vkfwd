...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::GetDeviceQueue) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkGetDeviceQueue::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkGetDeviceQueue::Response;
...
#if __has_include("hook/vkGetDeviceQueueHook.hpp")
    #include "hook/vkGetDeviceQueueHook.hpp"
#endif
