...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::GetPhysicalDeviceFeatures) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkGetPhysicalDeviceFeatures::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkGetPhysicalDeviceFeatures::Response;
...
#if __has_include("hook/vkGetPhysicalDeviceFeaturesHook.hpp")
    #include "hook/vkGetPhysicalDeviceFeaturesHook.hpp"
#endif
