...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::CreateGraphicsPipelines) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkCreateGraphicsPipelines::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkCreateGraphicsPipelines::Response;
...
#if __has_include("hook/vkCreateGraphicsPipelinesHook.hpp")
    #include "hook/vkCreateGraphicsPipelinesHook.hpp"
#endif
