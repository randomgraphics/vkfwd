...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::EnumeratePhysicalDevices) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkEnumeratePhysicalDevices::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkEnumeratePhysicalDevices::Response;
...
#if __has_include("hook/vkEnumeratePhysicalDevicesHook.hpp")
    #include "hook/vkEnumeratePhysicalDevicesHook.hpp"
#endif
