...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::AllocateMemory) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkAllocateMemory::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkAllocateMemory::Response;
...
#if __has_include("hook/vkAllocateMemoryHook.hpp")
    #include "hook/vkAllocateMemoryHook.hpp"
#endif
