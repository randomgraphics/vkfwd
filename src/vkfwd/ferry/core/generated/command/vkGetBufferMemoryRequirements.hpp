...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::GetBufferMemoryRequirements) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkGetBufferMemoryRequirements::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkGetBufferMemoryRequirements::Response;
...
#if __has_include("hook/vkGetBufferMemoryRequirementsHook.hpp")
    #include "hook/vkGetBufferMemoryRequirementsHook.hpp"
#endif
