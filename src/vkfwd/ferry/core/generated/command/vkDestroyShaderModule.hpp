...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::DestroyShaderModule) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkDestroyShaderModule::Parameters;
...
#if __has_include("hook/vkDestroyShaderModuleHook.hpp")
    #include "hook/vkDestroyShaderModuleHook.hpp"
#endif
