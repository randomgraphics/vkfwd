...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::DeviceWaitIdle) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkDeviceWaitIdle::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkDeviceWaitIdle::Response;
...
#if __has_include("hook/vkDeviceWaitIdleHook.hpp")
    #include "hook/vkDeviceWaitIdleHook.hpp"
#endif
