...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::CreateRenderPass) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkCreateRenderPass::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkCreateRenderPass::Response;
...
#if __has_include("hook/vkCreateRenderPassHook.hpp")
    #include "hook/vkCreateRenderPassHook.hpp"
#endif
