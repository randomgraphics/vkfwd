...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::CreateBuffer) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkCreateBuffer::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkCreateBuffer::Response;
...
#if __has_include("hook/vkCreateBufferHook.hpp")
    #include "hook/vkCreateBufferHook.hpp"
#endif
