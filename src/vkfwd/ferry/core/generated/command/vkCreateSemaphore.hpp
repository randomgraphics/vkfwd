...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::CreateSemaphore) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkCreateSemaphore::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkCreateSemaphore::Response;
...
#if __has_include("hook/vkCreateSemaphoreHook.hpp")
    #include "hook/vkCreateSemaphoreHook.hpp"
#endif
