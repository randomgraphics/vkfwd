...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::DestroyPipelineLayout) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkDestroyPipelineLayout::Parameters;
...
#if __has_include("hook/vkDestroyPipelineLayoutHook.hpp")
    #include "hook/vkDestroyPipelineLayoutHook.hpp"
#endif
