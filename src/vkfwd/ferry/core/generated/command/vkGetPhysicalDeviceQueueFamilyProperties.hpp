...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::GetPhysicalDeviceQueueFamilyProperties) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkGetPhysicalDeviceQueueFamilyProperties::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkGetPhysicalDeviceQueueFamilyProperties::Response;
...
#if __has_include("hook/vkGetPhysicalDeviceQueueFamilyPropertiesHook.hpp")
    #include "hook/vkGetPhysicalDeviceQueueFamilyPropertiesHook.hpp"
#endif
