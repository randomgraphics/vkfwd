...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::MapMemory) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkMapMemory::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkMapMemory::Response;
...
#if __has_include("hook/vkMapMemoryHook.hpp")
    #include "hook/vkMapMemoryHook.hpp"
#endif
