...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::DestroyPipeline) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkDestroyPipeline::Parameters;
...
#if __has_include("hook/vkDestroyPipelineHook.hpp")
    #include "hook/vkDestroyPipelineHook.hpp"
#endif
