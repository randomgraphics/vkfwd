...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::DestroyBuffer) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkDestroyBuffer::Parameters;
...
#if __has_include("hook/vkDestroyBufferHook.hpp")
    #include "hook/vkDestroyBufferHook.hpp"
#endif
