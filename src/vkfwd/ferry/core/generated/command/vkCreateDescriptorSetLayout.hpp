...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::CreateDescriptorSetLayout) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkCreateDescriptorSetLayout::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkCreateDescriptorSetLayout::Response;
...
#if __has_include("hook/vkCreateDescriptorSetLayoutHook.hpp")
    #include "hook/vkCreateDescriptorSetLayoutHook.hpp"
#endif
