...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::GetPhysicalDeviceMemoryProperties) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkGetPhysicalDeviceMemoryProperties::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkGetPhysicalDeviceMemoryProperties::Response;
...
#if __has_include("hook/vkGetPhysicalDeviceMemoryPropertiesHook.hpp")
    #include "hook/vkGetPhysicalDeviceMemoryPropertiesHook.hpp"
#endif
