...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::DestroySemaphore) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkDestroySemaphore::Parameters;
...
#if __has_include("hook/vkDestroySemaphoreHook.hpp")
    #include "hook/vkDestroySemaphoreHook.hpp"
#endif
