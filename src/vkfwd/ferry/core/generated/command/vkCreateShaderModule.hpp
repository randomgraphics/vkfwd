...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::CreateShaderModule) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkCreateShaderModule::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkCreateShaderModule::Response;
...
#if __has_include("hook/vkCreateShaderModuleHook.hpp")
    #include "hook/vkCreateShaderModuleHook.hpp"
#endif
