...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::DestroyDescriptorSetLayout) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkDestroyDescriptorSetLayout::Parameters;
...
#if __has_include("hook/vkDestroyDescriptorSetLayoutHook.hpp")
    #include "hook/vkDestroyDescriptorSetLayoutHook.hpp"
#endif
