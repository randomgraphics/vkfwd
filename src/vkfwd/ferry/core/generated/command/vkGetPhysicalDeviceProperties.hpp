...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::GetPhysicalDeviceProperties) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkGetPhysicalDeviceProperties::Parameters;
    ...
    using Response = vkfwd::generated::commands::vkGetPhysicalDeviceProperties::Response;
...
#if __has_include("hook/vkGetPhysicalDevicePropertiesHook.hpp")
    #include "hook/vkGetPhysicalDevicePropertiesHook.hpp"
#endif
