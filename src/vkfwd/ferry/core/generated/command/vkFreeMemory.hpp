...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::FreeMemory) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkFreeMemory::Parameters;
...
#if __has_include("hook/vkFreeMemoryHook.hpp")
    #include "hook/vkFreeMemoryHook.hpp"
#endif
