...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::DestroyRenderPass) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkDestroyRenderPass::Parameters;
...
#if __has_include("hook/vkDestroyRenderPassHook.hpp")
    #include "hook/vkDestroyRenderPassHook.hpp"
#endif
