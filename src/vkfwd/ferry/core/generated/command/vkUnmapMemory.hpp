...
static_assert(static_cast<std::uint32_t>(::vkfwd::generated::CommandId::UnmapMemory) < ::vkfwd::kReservedCommandIdBase,
...
class Command {
public:
    using Parameters = vkfwd::generated::commands::vkUnmapMemory::Parameters;
...
#if __has_include("hook/vkUnmapMemoryHook.hpp")
    #include "hook/vkUnmapMemoryHook.hpp"
#endif
