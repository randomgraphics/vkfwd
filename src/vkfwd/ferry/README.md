...
intercepted call to an API endpoint. The forwarder does not call a local Vulkan
...
policy belongs behind the endpoint boundary.
...
body shape is hook, pack, endpoint, unpack response, hook, return. The endpoint
