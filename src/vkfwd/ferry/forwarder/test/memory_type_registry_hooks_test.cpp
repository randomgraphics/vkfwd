...
CommandStream handle_create_device(CommandStream & request_stream) {
    ...
    *params->pDevice = expected.created_device;
    ...
    Command::Response r {.return_value = expected.create_device_result, .pDevice = params->pDevice};
...
CommandStream handle_destroy_device(CommandStream & /*request_stream*/) { return CommandStream {}; }
...
TEST_CASE("vkCreateDevice forwarder hook records device->physicalDevice mapping") {
    ...
    const VkResult result = vkfwd::forwarder::generated::vkCreateDevice_entry(s.physical_device, &create_info, nullptr, &device);
...
TEST_CASE("vkGetPhysicalDeviceMemoryProperties forwarder hook records memory properties") {
    ...
    VkPhysicalDeviceMemoryProperties props {};
    vkfwd::forwarder::generated::vkGetPhysicalDeviceMemoryProperties_entry(s.physical_device, &props);
...
TEST_CASE("vkGetPhysicalDeviceProperties forwarder hook records nonCoherentAtomSize and minMemoryMapAlignment") {
    ...
    vkfwd::forwarder::generated::vkGetPhysicalDeviceProperties_entry(s.physical_device, &props);
