...
#if __has_include("hook/vkDeviceWaitIdleForwarderHook.hpp")
    #include "hook/vkDeviceWaitIdleForwarderHook.hpp"
#endif
...
VKAPI_ATTR VkResult VKAPI_CALL vkDeviceWaitIdle_entry(VkDevice device) {
    ...
    using Hooks   = ::vkfwd::forwarder::manual::CommandHooks<::vkfwd::generated::CommandId::DeviceWaitIdle>;

    if constexpr (Hooks::before_pack_enabled) { Hooks::before_pack(device); }
